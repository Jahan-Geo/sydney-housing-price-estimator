...
# HousingFeatureEngineer instance. Unpickling requires this class to exist
# under the same name in this module, so it is repeated here. It must stay
# consistent with the version in Section 3.1.
# ---------------------------------------------------------------------------
